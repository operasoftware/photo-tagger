...
(function()
{
    ...
    function addHoverEvents(img, mouseOverHandler) {
        var handler = mouseOverHandler || imageMouseOver;
        img.addEventListener('mouseover', function() { handler(img) }, false);
    ...
    function imageMouseOver(source){
        showButton = false;
    ...
    function FlickrImageMouseOver(source){
    ...
    function FlickrImageMouseOver2(source){
    ...
    function showImage(image) {
        ...
        tagButton.dataset['tag'] = image.src + '#|#' + image.width + '#|#' + image.height;
    }
